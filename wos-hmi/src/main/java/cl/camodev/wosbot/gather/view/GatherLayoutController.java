...
public class GatherLayoutController extends AbstractProfileController {
	...
	private CheckBox checkBoxGatherResources, checkBoxGatherCoal, checkBoxGatherIron,
			...
			checkBoxGatherSpeedBoost, checkBoxRemoveHeros, checkBoxTestPreemption;
	@FXML
	...
	private void initialize() {
		...
		checkBoxMappings.put(checkBoxTestPreemption, EnumConfigurationKey.TEST_GATHER_DEPLOY_PREEMPTION_BOOL);
